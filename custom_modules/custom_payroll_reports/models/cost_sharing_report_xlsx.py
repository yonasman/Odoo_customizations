...
class CostSharingSummaryReportXlsx(ReportXlsxAbstract, models.AbstractModel):
    _name = 'report.custom_payroll_reports.report_cost_sharing_summary_xlsx'
    _description = 'Cost Sharing Summary Report Excel'
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        sheet.write('J1', "Total Taxable (If the employee has no Total Taxable,Please put 0 - Do not leave it blank)",
                    header_format_white_top)
        sheet.write('K1', "Tax withheld (If the employee has no Tax withheld ,Please put 0 - Do not leave it blank)",
                    header_format_white_top)
        ...
        for employee_id, item in report_data.items():
            ...
            if cost_sharing_10 != 0:
                ...
                sheet.write('I' + str(row), round(other_taxable_benefit, 2) if other_taxable_benefit != 0 else '0', cell_format)

...
class IncomeTaxSummaryReportXlsx(ReportXlsxAbstract, models.AbstractModel):
    _name = 'report.custom_payroll_reports.report_income_tax_summary_xlsx'

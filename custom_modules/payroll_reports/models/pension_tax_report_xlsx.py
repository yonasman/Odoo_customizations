...
class PayrollSummaryReportXlsx(ReportXlsxAbstract, models.AbstractModel):
    _name = 'report.payroll_reports.report_pension_tax_summary_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        sheet.merge_range('D7:G7', " ", header_format_white_3)
        sheet.merge_range('D8:G8', " ", header_format_white_3)

        sheet.merge_range('A8:E8', 'TELEPORT TECHNOLOGIES PLC', header_format_left)
        sheet.merge_range('F8:J8', '0051852115', header_format_left)
        sheet.merge_range('K8:N8', 'Bulehora', header_format_left)
        sheet.merge_range('O8:P8', for_month, header_format_new)
        ...
        sheet.merge_range('C11:D11', '2d. Kebele/Famers Association', header_format_left)
